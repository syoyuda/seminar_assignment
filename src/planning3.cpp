...
--------------------------------*/
    ...
    /* 無限ループ:while{ros::ok())を利用して動作制御入力を発生
        ...
        ros::WallDuration change_course_t = ros::WallDuration(11.0);
        ros::WallDuration arrival_t = ros::WallDuration(21.0);
        ros::WallDuration f_t = ros::WallDuration(40.0);
